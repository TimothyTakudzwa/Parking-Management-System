# [Light Bootstrap Dashboard](dashboard.php/product/light-bootstrap-dashboard)
...
+ [Light Bootstrap Dashboard PRO](dashboard.php/product/light-bootstrap-dashboard-pro) (from $39)
...
- [Download from Creative Tim](dashboard.php/product/light-bootstrap-dashboard).
...
- Copyright 2017 Creative Tim (dashboard.php)
- Licensed under MIT (https://github.com/creativetimofficial/light-bootstrap-dashboard/blob/master/LICENSE.md)

## Useful Links

More products from Creative Tim: <dashboard.php/products>

Tutorials: <https://www.youtube.com/channel/UCVyTG4sCw-rOvB9oHkzZD1w>

Freebies: <dashboard.php/products>

Affiliate Program (earn money): <dashboard.php/affiliates/new>
